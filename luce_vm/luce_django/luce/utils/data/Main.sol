...
pragma solidity ^0.6.2;
    ...
    contract Dataset is ERC721 {
         ...
         */
        function setConsentAddress(address userConsent) public onlyOwner providerGasCost {
            consent = userConsent;
        }
    ...
    contract LuceMain is Dataset {
        ...
        function burn(uint tokenId) public {
            require (userOf(tokenId) == msg.sender || dataProvider == msg.sender || burnPermission);
